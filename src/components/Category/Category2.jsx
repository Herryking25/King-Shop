    ...
    <div className='py-8'>
      <div className='container'>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* first col */}
          <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100  text-white
            ...
            rounded-3xl relative h-[320px] flex items-start'>
                <div>
                    <div className='mb-4'>
                        ...
                        <p className='text-4xl xl:text-5xl font-bold opacity-20'>VR</p>
                        <Button 
                        text="Browse Now"
                        bgColor={"bg-white"}

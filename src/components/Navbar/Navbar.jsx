            ...
            {/* Navbar Right Section */}
              <div className='flex justify-between items-center gap-4'>
                ...
                <div className='relative group hidden sm:block'>
                    ...
                    <IoMdSearch  className='text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute
                    top-1/4 -translate-y-1/2: right-3 duration-200' />
                </div>

                {/* Order Section */}
                        <button className='relative p-3' onClick={handleOderPopup}>

                ...
                <div key={data.id}>
                    ...
                    {/* text content Section */}
                        ...
                        text-center sm:text-left order-2 sm:order-1 relative z-10'>
                            ...
                            <h1 className='text-5xl sm:text-6xl lg:7xl font-bold'>{data.title}</h1>
                    ...
                    <div className='order-1 sm:order-2'>
                        <div>
                            ...
                            className='w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto
